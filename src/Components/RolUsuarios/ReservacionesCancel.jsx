...
const ReservacionesCancel = () => {
  const [reserCancel, setReserCancel] = useState([]);
  useEffect(() => {
    const getReservaciones = async () => {
      ...
      try {
        const { data } = await axios(
          `${import.meta.env.VITE_BACKEND_URL}/fiestisimo/reservations/cancel`,
          config
        );
...
export default ReservacionesCancel;
